...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_TestRandom_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_TestRandom_t qt_meta_stringdata_TestRandom = {
    {
QT_MOC_LITERAL(0, 10), // "TestRandom"
...
const QMetaObject TestRandom::staticMetaObject = { {
    ...
    qt_meta_stringdata_TestRandom.offsetsAndSize,
    qt_meta_data_TestRandom,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TestRandom_t
